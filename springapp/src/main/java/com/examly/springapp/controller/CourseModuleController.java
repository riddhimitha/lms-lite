...
public class CourseModuleController {
    ...
    public CourseModule updateProgress(@PathVariable Long id, @RequestParam String student, @RequestParam Integer progress) {
    ...
    @PostMapping("/{id}/quiz")
    public Map<String, String> submitQuiz(@PathVariable Long id, @RequestParam String student, @RequestParam Integer score) {
